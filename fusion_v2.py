...
image_rgb_path = "/home/isa/TFG/image_right-1624013356.966232061.jpg"  # Ruta de la imagen rgb a procesar
image_rgb = crop_image(image_rgb_path)

# Cargar la imagen térmica
image_term_path = "/home/isa/TFG/image_the-1624013357.859271049.jpg"  # Ruta de la imagen térmica a procesar
image_term = cv2.imread(image_term_path)

# Realizar las detecciones en las imagenes
results_rgb = model_rgb.predict(project="TFG", name="RGB_network", stream=True, source=image_rgb, save=True, save_txt=True, save_conf=True)
results_term = model_term.predict(project="TFG", name="TIR_network", stream=True, source=image_term, save=True, save_txt=True, save_conf=True)
